...
plot(time(2,:),numPoints,'-+','DisplayName','2 workers');
plot(time(3,:),numPoints,'-*','DisplayName','3 workers');
plot(time(4,:),numPoints,'-x','DisplayName','4 workers');
plot(time(5,:),numPoints,'-s','DisplayName','5 workers');
plot(time(6,:),numPoints,'-d','DisplayName','6 workers');
plot(time(7,:),numPoints,'-.^','DisplayName','7 workers');
plot(time(8,:),numPoints,'-.v','DisplayName','8 workers');
plot(time(9,:),numPoints,'-.<','DisplayName','9 workers'); 
plot(time(10,:),numPoints,'-.>','DisplayName','10 workers'); hold off;
